...
async function syncCensoFromCSV() {
  try {
    ...
    // Lista de chapas con especialidad de trincador
    const chapasTrincadores = [
      ...
      '167', '756', '212', '720', '739', '145', '692', '135', '734', '775',
      '935', '656', '663', '136', '624', '760', '223', '525', '230', '988',
      ...
      '685', '891', '224', '140', '901', '886', '144', '186', '284', '336',
      '102', '183', '187', '678', '161', '687', '116', '727', '674', '959',
      '985', '963', '909', '940', '944', '801', '982', '641', '535', '150',
      ...
      '951', '872', '861', '911', '711', '875', '247', '883', '868', '245',
      '837', '559', '914', '549', '195'
    ];
