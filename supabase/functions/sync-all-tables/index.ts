...
// MODIFICADO: Se ejecuta a cualquier hora del día (24/7)
// Antes: Solo 07:00-16:00 | Ahora: Sin restricciones de horario
...
// ============================================================================
// FUNCIÓN DE VERIFICACIÓN DE HORARIO DESHABILITADA
// ============================================================================
// Comentada para permitir ejecución 24/7
// Si quieres reactivarla en el futuro, descomenta la función y su llamada
// ============================================================================
/*
...
async function sincronizarJornales(supabase: any) {
  try {
    ...
    // Insertar usando upsert en lotes de 100
    let insertados = 0;
    let errores = 0;
...
async function sincronizarIRPF(supabase: any) {
  try {
...
async function sincronizarPrimas(supabase: any) {
  try {
...
async function sincronizarForo(supabase: any) {
  try {
...
// ============================================================================
// HANDLER PRINCIPAL - MODIFICADO PARA EJECUTAR 24/7
// ============================================================================
serve(async (req)=>{
  try {
    console.log('🚀 Iniciando sincronización automática (24/7)...');

    // ========================================================================
    // VERIFICACIÓN DE HORARIO DESHABILITADA
    // ========================================================================
    // La verificación de horario laboral ha sido eliminada para permitir
    // que la sincronización se ejecute a cualquier hora del día.
    // ========================================================================
    /*
    if (!esHorarioLaboral()) {
    ...
    */
    ...
    return new Response(JSON.stringify({
      ...
      modo: '24/7 (sin restricción de horario)',
      resultados
    }), {
      headers: {
        'Content-Type': 'application/json'
